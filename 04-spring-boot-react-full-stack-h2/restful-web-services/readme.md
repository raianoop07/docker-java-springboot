...
- REST API - Import `restful-web-services` into Eclipse as Maven Project. Run `com.rai.rest.webservices.restfulwebservices.RestfulWebServicesApplication` as a Java Application. Check Authentication and REST API Sections for executing REST APIs.
- React Application - Import `frontend/todo-app` into Visual Studio Code. Run `npm install` followed by `npm start`
- http://localhost:4200/ with credentials rai/dummy
...
- http://localhost:5000/hello-world/path-variable/rai

```json
{"message":"Hello World, rai"}
```

## TODO Resource Details

- GET - http://localhost:5000/jpa/users/rai/todos
...
- GET - http://localhost:5000/jpa/users/rai/todos/10001
...
- POST to http://localhost:5000/jpa/users/rai/todos with BODY of Request given below
...
- http://localhost:5000/jpa/users/rai/todos/10001 with BODY of Request given below
...
- DELETE to http://localhost:5000/jpa/users/rai/todos/10001
...
ENTRYPOINT ["java","-cp","app:app/lib/*","com.rai.rest.webservices.restfulwebservices.RestfulWebServicesApplication"]
```