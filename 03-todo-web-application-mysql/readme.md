...
```
docker container run -p 8080:8080 --link=mysql -e RDS_HOSTNAME=mysql  raianoop07/todo-web-application-mysql:0.0.1-SNAPSHOT
```

Using Custom Network

```
docker container run -p 8080:8080 --network=web-application-mysql-network -e RDS_HOSTNAME=mysql  raianoop07/todo-web-application-mysql:0.0.1-SNAPSHOT
```
...
+----+--------------+---------+----------------------------+-------------+
|  1 | Default Desc | 0       | 2019-06-26 18:30:00.000000 | raianoop07 |
+----+--------------+---------+----------------------------+-------------+
